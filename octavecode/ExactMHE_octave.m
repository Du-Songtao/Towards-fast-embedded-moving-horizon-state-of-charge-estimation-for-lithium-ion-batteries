function[SOCEst,SOC,SOCRMSE,meanTime,maxTime,nIter,objValue] = ExactMHE_octave(P0,Q,R,I,y,SOC,V1,OCVCoefficient,RsCoefficient,R1Coefficient,C1Coefficient,tDelta,errorInitialEstimation,Cn,N,options)
    rng('default');
